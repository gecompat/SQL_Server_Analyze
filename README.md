...
Die Version `1.1.0-special.9` ergänzt die P2-Module für Verschlüsselungslebenszyklus und Wartungsoperationen. Der Release-Gate-Vertrag umfasst nun 17 Suiten; P0, P1-IQP, P1-Contention und der read-only P1-Speichervertrag besitzen commitbezogene Drei-Versionen-Evidenz. Als nächste P1-Gruppe folgt der Backupkettenvertrag. Weitere Feature-Positiv-, Grenzwert-, Last- und externe Restorefälle bleiben separate Nachweise.
