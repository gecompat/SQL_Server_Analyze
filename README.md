...
- versionsabhängige Capability-Erkennung, leichtgewichtige Spezialfeature-Inventur und isolierte In-Memory-OLTP-Tiefenanalyse mit opt-in Hashketten
...
Der Basisstand vor der Spezialfallwelle wurde nach Angabe des Projektverantwortlichen installiert, kompiliert und funktional getestet. Die neue Version `1.1.0-special.4` einschließlich begrenzter Statistikverteilung, Spezialfeature-Inventur und In-Memory-OLTP-Tiefenanalyse besitzt statische API- und Installerverträge; reale Läufe der dokumentierten Zielmatrix stehen noch aus.
