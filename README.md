...
Die Version `1.1.0-special.9` ergänzt die P2-Module für Verschlüsselungslebenszyklus und Wartungsoperationen. Der Release-Gate-Vertrag umfasst nun 17 Suiten; P0, P1-IQP und P1-Contention besitzen Drei-Versionen-Evidenz, der neue read-only P1-Speichervertrag wartet noch auf commitbezogene Actions. Weitere Feature-Positiv-, Grenzwert-, Last- und externe Restorefälle bleiben separate Nachweise.
