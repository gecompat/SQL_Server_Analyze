...
Die Version `1.1.0-special.9` ergänzt die P2-Module für Verschlüsselungslebenszyklus und Wartungsoperationen. Der Release-Gate-Vertrag umfasst nun 18 Suiten; P0, P1-IQP, P1-Contention, P1-Speicher und der synthetische P1-Backupkettenvertrag besitzen commitbezogene Drei-Versionen-Evidenz. Der Backupvertrag führt keinen Restore aus; als nächste P1-Gruppe folgt Schema-/Designkorrektheit. Weitere Feature-Positiv-, Grenzwert-, Last- und externe Restorefälle bleiben separate Nachweise.
