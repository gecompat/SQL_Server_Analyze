...
Die Version `1.1.0-special.9` ergänzt die P2-Module für Verschlüsselungslebenszyklus und Wartungsoperationen. Der Release-Gate-Vertrag umfasst nun 16 Suiten: vollständiges P0 und die ersten vier P1-IQP-Fälle besitzen Drei-Versionen-Evidenz; der neue P1-Contention-Vertrag wartet noch auf commitbezogene Actions-Läufe für SQL Server 2019, 2022 und 2025. Weitere Feature-Positiv-, Grenzwert-, Last- und externe Restorefälle bleiben separate Nachweise.
