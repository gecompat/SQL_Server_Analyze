...
- versionsabhängige Capability-Erkennung sowie leichtgewichtige Nutzungsinventur für Spezialfeatures mit strukturierten Fallback- und Statusinformationen
...
Der Basisstand vor der Spezialfallwelle wurde nach Angabe des Projektverantwortlichen installiert, kompiliert und funktional getestet. Die neue Version `1.1.0-special.3` einschließlich begrenzter Statistikverteilungsanalyse und leichtgewichtiger Spezialfeature-Nutzungsinventur besitzt statische API- und Installerverträge; reale Läufe der dokumentierten Zielmatrix stehen noch aus.
