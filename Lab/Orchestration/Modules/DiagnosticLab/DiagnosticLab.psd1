@{
    ...
    Description = 'LAB-001 preflight, bounded Docker and Podman orchestration, SQL Server container baselines, core performance scenarios, version lanes, and generic container framework installation.'
