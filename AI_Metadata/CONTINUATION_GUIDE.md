...
Der real getestete Basisstand vom 17.07.2026 bleibt die Ausgangsbasis. Die danach ergänzte Spezialfallwelle bis `1.1.0-special.6` benötigt zusätzlich `167_Special_Case_API_Contract.sql` und dokumentierte Zielmatrixläufe, bevor sie als laufzeitgetestet gelten darf. P2 umfasst die Nutzungsinventur sowie die implementierten In-Memory-OLTP-, Temporal-Tables- und Service-Broker-Tiefenmodule; weitere geplante Deep-Dive-Module dürfen nicht als bereits verfügbar beschrieben werden.
