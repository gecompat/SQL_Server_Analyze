...
Der real getestete Basisstand vom 17.07.2026 bleibt die Ausgangsbasis. Die danach ergänzte Spezialfallwelle bis `1.1.0-special.3` benötigt zusätzlich `167_Special_Case_API_Contract.sql` und dokumentierte Zielmatrixläufe, bevor sie als laufzeitgetestet gelten darf. P2 hat mit der reinen Nutzungsinventur begonnen; geplante Deep-Dive-Module dürfen nicht als bereits verfügbar beschrieben werden.
