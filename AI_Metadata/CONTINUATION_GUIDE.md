...
- Reale Benutzer-, Organisations-, Umgebungs- oder Fachwerte dürfen in einer berechtigten interaktiven Diagnoseausgabe vorkommen, aber niemals in Repository-, Dokumentations-, Test- oder Downloadartefakte übernommen werden.
- Beispiele und gespeicherte Testergebnisse verwenden ausschließlich synthetische Werte.
- Bei einem uneindeutigen Artefaktwert vor der Aufnahme nachfragen; keine stillschweigende Freigabe annehmen.

## Nach jeder Änderung

- statischen API-, Portabilitäts-, Quellen- und Datenschutz-Audit ausführen;
- Datenschutzprüfung auf den vollständigen Lieferumfang anwenden, ohne gefundene sensitive Werte in der Prüfausgabe zu vervielfältigen;
