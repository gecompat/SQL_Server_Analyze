...
Der real getestete Basisstand vom 17.07.2026 bleibt die Ausgangsbasis. Die danach ergänzte Spezialfallwelle `1.1.0-special.2` benötigt zusätzlich `167_Special_Case_API_Contract.sql` und dokumentierte Zielmatrixläufe, bevor sie als laufzeitgetestet gelten darf.
