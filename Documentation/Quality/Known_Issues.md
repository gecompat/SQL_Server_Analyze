...
- Die vier P1-Schema-/Designfälle sind als neunzehnte Suite automatisiert, bleiben aber bis zu grünen commitbezogenen SQL-Server-2019-/2022-/2025-Gates `NOT_EXECUTED`. Alle generischen Constraint-, FK-, Index- und Identity-Fixtures werden in einer Transaktion vollständig zurückgerollt.
