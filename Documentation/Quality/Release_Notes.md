...
- Der synthetische `EV-SEVERE`-XE-Vertrag verwendet verlustfreie Ereignisaufbewahrung, eine Sekunde Dispatch-Latenz und wartet vor dem Stop auf die Dateiausgabe. Dadurch wird der einzelne kontrollierte Fehler nicht mehr vom asynchronen Eventfile-Flush überholt.
