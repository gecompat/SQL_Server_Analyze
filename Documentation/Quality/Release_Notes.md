...
- Nach sporadisch vollständig verlorenen kurzen Event-Bursts erzwingt `EV-SEVERE` nun `NO_EVENT_LOSS`, zwanzig kontrollierte Ereignisse und längere Flushfenster vor und nach dem Sessionstop. Der Test bleibt auf das generische synthetische Event und die kurzlebige XEL-Datei begrenzt.
