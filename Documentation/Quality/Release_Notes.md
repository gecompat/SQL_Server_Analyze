...
- Die siebzehnte Suite deckt als nächste P1-Gruppe leichten Speicherbaselinepfad, bedingte Pressure-Findings, unveränderte Resource-Semaphore-Waiter und den ausdrücklich aktivierten, begrenzten Buffer-Descriptor-Scan ab. Kein künstlicher Speicherdruck wird erzeugt; Statuszeilen bleiben bis zu grünen Actions unverändert.
