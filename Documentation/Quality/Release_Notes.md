...
- `169_P0_Runtime_Contract.sql` führt 15 Positiv-, Leer-, Grenz- und Resetfälle mit generischen DBCC-, Dateioptions-, Performance-Counter- und XE-Fixtures aus. `INT-DENIED` und `CAP-DENIED` laufen in der versionsspezifischen Berechtigungsmatrix unter einem tatsächlich eingeschränkten synthetischen Serverlogin; damit sind alle 17 P0-Fälle automatisiert, der neue Resetnachweis wartet noch auf die commitbezogenen Drei-Versionen-Gates.
