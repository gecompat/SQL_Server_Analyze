...
- Die siebzehnte Suite deckt als nächste P1-Gruppe leichten Speicherbaselinepfad, bedingte Pressure-Findings, einen strukturell vollständigen Resource-Semaphore-Snapshot und den ausdrücklich aktivierten, begrenzten Buffer-Descriptor-Scan ab. Veränderliche Semaphore-Zähler werden innerhalb der erfassten Momentaufnahme validiert und nicht durch einen zeitlich späteren DMV-Read verglichen. Kein künstlicher Speicherdruck wird erzeugt; Statuszeilen bleiben bis zu grünen Actions unverändert.
