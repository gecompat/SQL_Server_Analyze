...
Prüfen Sie die Angaben in der Reihenfolge Statement → Warnungen → Operatoren → absolute Estimate- und Actual-Werte → Memory → Parameter. Berücksichtigen Sie absolute Zeilenmengen vor Ratios.
