...
/*
===============================================================================
Datei        : 128_ServerNuma_Collation_Runtime_Contract.sql
Zweck        : Der Test prueft die NUMA-Analyse mit explizit kollationierter
               lokaler Arbeits-Temp-Tabelle.
...
IF ISJSON(@Json) <> 1
    THROW 54914,N'Der NUMA-Collationvertrag lieferte kein JSON-Ergebnis.',1;
IF @StatusCode <> 'AVAILABLE' OR @IsPartial <> 0 OR @ErrorNumber IS NOT NULL OR @ErrorMessage IS NOT NULL
    THROW 54915,N'Der NUMA-Collationvertrag lieferte keinen vollstaendigen Quellstatus.',1;
GO
