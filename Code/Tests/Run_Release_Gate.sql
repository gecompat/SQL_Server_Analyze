...
RAISERROR(N'RELEASE_GATE 1/31: Smoke Test',10,1) WITH NOWAIT;
:r Integration/110_Smoke_Test.sql

RAISERROR(N'RELEASE_GATE 2/31: Parameter-API-Vertrag',10,1) WITH NOWAIT;
:r Integration/163_Parameter_API_Vertrag.sql

RAISERROR(N'RELEASE_GATE 3/31: Filter- und Ausgabe-Vertrag',10,1) WITH NOWAIT;
:r Integration/165_Filter_Output_Contract.sql

RAISERROR(N'RELEASE_GATE 4/31: Spezialfall-API-Vertrag',10,1) WITH NOWAIT;
:r Integration/167_Special_Case_API_Contract.sql

RAISERROR(N'RELEASE_GATE 5/31: Spezialfall-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/168_Special_Case_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 6/31: P0-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/169_P0_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 7/31: P1-IQP-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/170_P1_IQP_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 8/31: P1-Contention-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/171_P1_Contention_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 9/31: P1-Speicher-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/172_P1_Memory_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 10/31: P1-Backupketten-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/173_P1_Backup_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 11/31: P1-Schema-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/174_P1_Schema_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 12/31: P1-Statistikverteilungs-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/175_P1_Statistics_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 13/31: P1-Availability-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/176_P1_Availability_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 14/31: P1-Agent-/Alert-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/177_P1_Agent_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 15/31: P1-Findings-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/178_P1_Diagnostic_Findings_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 16/31: P2-Spezialfeature-Inventur',10,1) WITH NOWAIT;
:r Integration/179_P2_Special_Feature_Inventory_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 17/31: P2-In-Memory-OLTP-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/180_P2_InMemory_Oltp_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 18/31: P2-Temporal-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/181_P2_Temporal_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 19/31: P2-Service-Broker-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/182_P2_Service_Broker_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 20/31: P2-Full-Text-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/183_P2_FullText_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 21/31: P2-Data-Capture-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/184_P2_Data_Capture_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 22/31: P2-Encryption-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/185_P2_Encryption_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 23/31: P2-Maintenance-Laufzeitvertrag',10,1) WITH NOWAIT;
:r Integration/186_P2_Maintenance_Runtime_Contract.sql

RAISERROR(N'RELEASE_GATE 24/31: Common',10,1) WITH NOWAIT;
:r Common/090_Test_und_Abnahme_Phase1A.sql

RAISERROR(N'RELEASE_GATE 25/31: Current State',10,1) WITH NOWAIT;
:r CurrentState/110_Test_und_Abnahme_Phase1B.sql

RAISERROR(N'RELEASE_GATE 26/31: Object und Index',10,1) WITH NOWAIT;
:r ObjectIndex/110_Test_und_Abnahme_Phase2.sql

RAISERROR(N'RELEASE_GATE 27/31: Plan Cache',10,1) WITH NOWAIT;
:r PlanCache/110_Test_und_Abnahme_Phase3.sql

RAISERROR(N'RELEASE_GATE 28/31: Query Store',10,1) WITH NOWAIT;
:r QueryStore/110_Test_und_Abnahme_Phase4.sql

RAISERROR(N'RELEASE_GATE 29/31: Extended Events',10,1) WITH NOWAIT;
:r ExtendedEvents/110_Test_und_Abnahme_Phase5.sql

RAISERROR(N'RELEASE_GATE 30/31: Infrastructure',10,1) WITH NOWAIT;
:r Infrastructure/110_Test_und_Abnahme_Phase6.sql

RAISERROR(N'RELEASE_GATE 31/31: Server Health',10,1) WITH NOWAIT;
...
SELECT CAST('AVAILABLE' AS varchar(40)) AS [StatusCode],
       ...
       CAST(31 AS int) AS [ExecutedSuites],
