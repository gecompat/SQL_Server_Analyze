...
BEGIN
    ...
    (
        ...
        , CONVERT(bit,HAS_PERMS_BY_NAME(NULL,N''SERVER'',N''VIEW SERVER STATE''))
        , CONVERT(bit,HAS_PERMS_BY_NAME(NULL,N''SERVER'',N''VIEW SERVER PERFORMANCE STATE''))
        , CONVERT(bit,HAS_PERMS_BY_NAME(DB_NAME(),N''DATABASE'',N''VIEW DATABASE STATE''))
