...
BEGIN
    ...
    (
        ...
        , CONVERT(bit,COALESCE(HAS_PERMS_BY_NAME(NULL,N''SERVER'',N''VIEW SERVER STATE''),0))
        , CONVERT(bit,COALESCE(HAS_PERMS_BY_NAME(NULL,N''SERVER'',N''VIEW SERVER PERFORMANCE STATE''),0))
