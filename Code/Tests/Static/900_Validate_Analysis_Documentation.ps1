...
if ($referenceNames.Count -ne 81) {
    $errors.Add("Expected 81 reference procedures, found $($referenceNames.Count).")
}
if ($sourceProcedureNames.Count -ne 81) {
    $errors.Add("Expected 81 canonical SQL procedures, found $($sourceProcedureNames.Count).")
}
if ($pageNames.Count -ne 81) {
    $errors.Add("Expected 81 procedure pages, found $($pageNames.Count).")
}
