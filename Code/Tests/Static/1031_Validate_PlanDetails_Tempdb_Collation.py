#!/usr/bin/env python3
"""Validate explicit framework collations in USP_PlanDetails work tables."""
...
TABLE_REQUIREMENTS = {
    "#PlanDetails_ResultTableMap": 2,
    "#PlanDetails_Attributes": 2,
    "#PlanDetails_Plans": 4,
    "#PlanDetails_CandidatesOutput": 3,
}
...
def main() -> int:
    ...
    if args.self_test:
        print("Plan Details tempdb-collation validator self-test passed.")
        return 0
    ...
    if errors:
        print("Plan Details tempdb-collation validation failed:", file=sys.stderr)
        print("\n".join(f"- {error}" for error in errors), file=sys.stderr)
        return 1
    print("Plan Details tempdb-collation validation passed.")
    return 0
