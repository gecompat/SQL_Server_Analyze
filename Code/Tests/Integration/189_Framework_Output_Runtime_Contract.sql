...
IF (SELECT COUNT(*) FROM [#FrameworkOutputRuntimeContract_Public])<>83
    INSERT [#FrameworkOutputRuntimeContract_Failure]
    VALUES(N'PUBLIC_INVENTORY',N'Die installierte öffentliche Procedure-Inventur enthält nicht genau 83 Vertragsobjekte.');
