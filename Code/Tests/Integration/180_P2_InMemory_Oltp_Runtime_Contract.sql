...
INSERT @StaticCases VALUES
    ...
    , ('XTP-CHECKPOINT',N'''WAITING_FOR_LOG_TRUNCATION_REVIEW''',N'@WaitingCheckpointWarnMb')
...
DECLARE @CheckpointFinding varchar(100)=CASE WHEN 2048>=1024 THEN 'WAITING_FOR_LOG_TRUNCATION_REVIEW' END;
...
IF @CheckpointFinding<>'WAITING_FOR_LOG_TRUNCATION_REVIEW'
