...
BEGIN
 ...
 SET LOCK_TIMEOUT 0;BEGIN TRY INSERT [#X] EXEC(N'DBCC TRACESTATUS(-1) WITH NO_INFOMSGS;');END TRY BEGIN CATCH SELECT @S=CASE WHEN ERROR_NUMBER()IN(229,297,300)THEN'DENIED_PERMISSION'ELSE'ERROR_HANDLED'END,@P=1,@E=ERROR_NUMBER(),@M=ERROR_MESSAGE();END CATCH;
